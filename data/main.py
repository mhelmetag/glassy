# using region overview (like https://services.surfline.com/kbyg/regions/overview?spotId=5842041f4e65fad6a7708966)
# filter to spot
...
for spot_id in SPOT_IDS:
  overview_response = requests.get(f"https://services.surfline.com/kbyg/regions/overview?spotId={spot_id}")
